...
const LinkSection = () => {
  ...
  //-- handle toggle menu (logout status)
  ...
  const userProfile = () => {
    localStorage.setItem(
      'fitFor',
      user?.fitFor === 0 ? 0 : user?.fitFor === 1 ? 1 : 2
    );
  };
  let badgeCount = 0;
      ...
      {user ? (
        <>
          ...
          >
            {({ TransitionProps }) => (
              <Transitions
                position={matchDownMD ? 'top-left' : 'top-left'}
                in={open}
                {...TransitionProps}
              >
                <Paper>
        ...
        <>
          ...
          >
            {({ TransitionProps }) => (
              <Transitions
                position={matchDownMD ? 'top' : 'top-right'}
                in={open}
                {...TransitionProps}
              >
                <Paper>
